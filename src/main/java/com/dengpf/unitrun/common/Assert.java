...
public class Assert {
   ...
   * thrown with the given message. If <code>unexpected</code> and <code>actual</code> are
  ...
  /**
   * Asserts that two floats are <b>not</b> equal to within a positive delta. If they are, an
   * {@link AssertionError} is thrown. If the unexpected value is infinity then the delta value is
   ...
   * {@link AssertionError} is thrown with the given message. If the expected value is infinity then
  ...
  /**
   * Asserts that two doubles are equal to within a positive delta. If they are not, an
   * {@link AssertionError} is thrown. If the expected value is infinity then the delta value is
   ...
   * be meaningfully applied only to values that could be assigned to a variable of type
   * <code>T</code>.
   *
   ...
   * {@link AssertionError} is thrown. If it throws the wrong type of exception, an
   * {@code AssertionError} is thrown describing the mismatch; the exception that was actually
   * thrown can be obtained by calling {@link AssertionError#getCause}.
   *
   * @param expectedThrowable the expected type of the exception
   * @param runnable a function that is expected to throw an exception when executed
    ...
    try {
      ...
      if (expectedThrowable.isInstance(actualThrown)) {
        ...
        String mismatchMessage =
            format("unexpected exception type thrown;", expectedThrowable.getSimpleName(),
