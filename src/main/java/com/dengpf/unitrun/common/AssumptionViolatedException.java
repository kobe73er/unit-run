...
public class AssumptionViolatedException extends RuntimeException implements SelfDescribing {
  ...
  /*
   * We have to use the f prefix until the next major release to ensure serialization compatibility.
  ...
  /**
   * An assumption exception with the given <i>value</i> (String or Throwable) and an additional
   * failing {@link Matcher}.
   *
   * @deprecated Please use {@link common.AssumptionViolatedException} instead.
   */
  @Deprecated
