...
public abstract class ComparisonCriteria {
   ...
   * <code>expecteds</code> and <code>actuals</code> are <code>null</code>, they are considered
   * equal.
   *
  ...
  private int assertArraysAreSameLength(Object expecteds, Object actuals, String header) {
    ...
    if (actualsLength != expectedsLength) {
      Assert.fail(header + "array lengths differed, expected.length=" + expectedsLength
